...
export default function Notes({ isOpen, taskId, taskText }: { isOpen: boolean; taskId?: string | null; taskText?: string }) {
  ...
  useEffect(() => {
    ...
    // Use the same path as task notes: users/${userId}/taskNotes/${taskId}
